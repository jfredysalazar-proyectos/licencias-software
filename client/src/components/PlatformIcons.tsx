...
const platformData: Record<Platform, { name: string; icon: React.ReactElement }> = {
  windows: {
    name: "Windows",
    icon: (
  ...
  android: {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-full h-full">
        <path
          fill="currentColor"
          d="M17.6 9.48l1.84-3.18c.16-.31.04-.69-.26-.85a.637.637 0 0 0-.83.22l-1.88 3.24a11.43 11.43 0 0 0-8.94 0L5.65 5.67a.643.643 0 0 0-.87-.2c-.28.18-.37.54-.22.83L6.4 9.48A10.81 10.81 0 0 0 1 18h22a10.81 10.81 0 0 0-5.4-8.52M7 15.25a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5m10 0a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5z"
        />
      </svg>
    ),
  },
...
export default function PlatformIcons({ platforms }: PlatformIconsProps) {
  ...
  return (
    <div className="border-t pt-6">
      <h3 className="text-lg font-semibold mb-3">Plataforma:</h3>
      <div className="flex gap-3">
        {platforms.map((platformId) => {
          const platform = platformData[platformId as Platform];
          ...
          return (
            <div
              ...
              title={platform.name}
            >
              <div className="w-12 h-12 bg-black rounded-lg p-2.5 text-white hover:bg-gray-800 transition-colors">
                {platform.icon}
              </div>
              {/* Tooltip */}
