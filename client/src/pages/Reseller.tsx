...
export default function Reseller() {
  ...
  const whatsappApprovalMsg = encodeURIComponent(
    `Hola, acabo de registrarme en la plataforma Licencias de Software Colombia con el correo ${pendingEmail} y quiero ser Reseller. Por favor, aprueba mi registro.`
  );
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 to-blue-700 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="px-8 py-8 text-center">
            ...
            <h2 className="text-xl font-bold text-gray-900 mb-2">Registro Recibido</h2>
            <p className="text-gray-600 mb-2">
              Tu solicitud de registro ha sido recibida exitosamente.
            </p>
            <p className="text-gray-600 mb-6">
              El <span className="font-semibold text-blue-700">Administrador</span> revisará y aprobará tu cuenta en el menor tiempo posible. Recibirás acceso una vez sea aprobada.
            </p>
            <div className="bg-blue-50 rounded-xl p-4 mb-6">
              <p className="text-sm text-blue-800 font-medium mb-1">¿Quieres acelerar el proceso?</p>
              <p className="text-sm text-blue-600">Contáctanos por WhatsApp para que el administrador apruebe tu registro más rápido.</p>
            </div>
            <a
              href={`https://wa.me/${ADMIN_WHATSAPP}?text=${whatsappApprovalMsg}`}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full py-3 px-4 bg-green-500 hover:bg-green-600 text-white font-semibold rounded-xl transition-colors shadow-md"
            >
            ...
            <button
              onClick={() => { setPendingApproval(false); setIsLoginMode(true); }}
